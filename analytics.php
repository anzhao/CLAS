            ...
            <table style="width:800px;height:auto;">
                <thead>
                    <tr style="border-bottom:1px solid black">
                        <th>Video(s)</th>
                        <th>Unique Users</th>
                        <th>Number of Enrolled Users</th>
                        <th>% of class</th>
                        <th>Total of Annotations</th>
                        <th>Average Annotation Per User</th>
                        <th>Total of Summaries</th>
                        <th>Average Summary Per User</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                            ...
                            ?>
                                <tr style="border-bottom:1px solid black">
                                    ...
                                    if (0 == $k) {
                                        ...
                                        echo "<td>";
                                        echo $media->getEnrolledUsers(70);
                                        echo "</td>";

                                        echo "<td>";
                                        echo round(($media->getUniqueUsers($videoIDs[$j]) / $media->getEnrolledUsers(70)), 2);
                                        echo "</td>";


                                        echo "<td>" . $media->getNumAnnotations($videoIDs[$j]) . "</td>";

                                        echo "<td>" . $media->getNumAnnotations($videoIDs[$j]) / $media->getUniqueUsers($videoIDs[$j]) . "</td>";

                                        echo "<td>" . $media->getNumSummaries($videoIDs[$j]) . "</td>";

                                        echo "<td>" . $media->getNumSummaries($videoIDs[$j]) / $media->getUniqueUsers($videoIDs[$j]) . "</td>";
                                    }
