...
{ ?>
    ...
    <div id="admin-bar">
        ...
        <a href="analytics.php" target="_blank" style="padding-left:20px">analytics</a <span style="padding-left:21em;font-size:13px;\"> user: <?php echo "\"       $userName\"" ?> </span>
...
function getStudentNumbers($sessionYear, $department, $courseNo, $sectionNo, $sessionCd = "W")
{
     ...
     * the student database in UBC. This function should be reimplemented to your school's
            ...
            <?php else : ?>
                <span style="font-size:14px;color:#e33">
                    <b>
                        ...
                        <br>
                        Service will resume as normal on Monday. Thanks, Arts ISIT @ UBC.
                        <br>
                        <br>
                    </b>
                </span>
                ...
                <br>
                &nbsp;&nbsp;&nbsp;
                <span id="clas_search_demo_in_1_minute_link" onMouseOut="linkMouseOut('clas_search_demo_in_1_minute_link')" onMouseOver="linkHoverHighlight('clas_search_demo_in_1_minute_link')" onMouseDown="linkClickHighlight('clas_search_demo_in_1_minute_link')" onMouseUp="showOneDemoVideo('clas_search_demo_in_1_minute','clas_search_demo_in_1_minute_link')" style="cursor:pointer;font-size:14px;text-decoration:underline;color:#003399;">
                    Links in Annotations and Many New Search Features - 1 Minute Video
                </span>
                <br>
                <!-- pull these classes into a style sheet for the login page! -->
                <iframe class="feature_videos" id="clas_search_demo_in_1_minute" width="600" height="337" src="//www.youtube.com/embed/ocqwz183yf0?rel=0" frameborder="0" allowfullscreen style="
					border-radius:6px;
					margin-bottom:10px;
					margin-top:4px;
					margin-left:7px;
